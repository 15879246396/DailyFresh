...
class MyUser(AbstractBaseUser, PermissionsMixin, GmtCreateModifiedTimeMixin):
    nick_name = models.CharField(verbose_name="用户昵称", max_length=64, null=True, blank=True)
    ...
    sex = models.CharField(verbose_name="性别", max_length=1, default="M")
    ...
    score = models.IntegerField(verbose_name='用户积分', max_length=11, null=False, default=False)

    openid = models.CharField(verbose_name='openid', blank=True, null=True, max_length=32, unique=True)
    unionid = models.CharField(verbose_name='unionid', blank=True, null=True, max_length=20, unique=True)
